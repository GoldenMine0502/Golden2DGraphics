...
import com.GoldenMine.구버전.actions.ActionLeftFlyAndCome;
import com.GoldenMine.구버전.actions.ActionRightFlyAndAway;
import com.GoldenMine.구버전.actions.IAction;
import com.GoldenMine.구버전.effectsV1.*;
import com.GoldenMine.구버전.graphicsV1.ObjectSprite;
...
public class Main {
    public static void main(String[] args) {
        ...
        IEffect scaleBigger = new EffectScaleBigger();
        ...
        sprite.registerEffect(fadeIn, 60, 15);
        sprite.registerEffect(fadeOut, 0, 15);
        ...
        sprite2.setPoint(250, 250);
        sprite2.registerEffect(rotate, 0, 900);
        sprite2.registerEffect(scaleBigger, 0, 900);
        ...
        //sprite2.enableEffect(scaleBigger);
